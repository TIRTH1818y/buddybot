...
class _FlutterPythonBackendState extends State<FlutterPythonBackend> {
  final String baseUrl = 'https://6000-idx-buddyspace-1736773471127.cluster-a3grjzek65cxex762e4mwrzl46.cloudworkstations.dev/api/data'; // Localhost URL
  ...
  Future<void> sendData(String userMessage) async {
    ...
    try {
      ...
      setState(() {
        var errorr = "Please Check Your Connection...";
        print(error);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: drawer(),
      appBar: AppBar(
          title: const Text("BuddyBot", style: TextStyle(color: Colors.white)),
    ...
    color: isUser ? Colors.blue.shade800 : Colors.white24,
